...
public class CreacionDeCuboEnAwake : MonoBehaviour
{
    ...
    private void Awake()
    {
        _objToSpawn = new GameObject("Cubo Creado En Awake");                           //Inicializamos un GameObject con un nombre perzonalizado.
        ...
        meshRendererMaterial.color = Color.red;                                         //Le asignamos un color a nuestro material que es el color blanco.
